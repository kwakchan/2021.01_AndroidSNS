...
package com.example.androidsns.fragment;
...
import com.example.androidsns.view.AutoFitTextureView;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture:
                ...
                break;
            case R.id.change:
                if(facingId == CameraCharacteristics.LENS_FACING_FRONT){ // 카메라가 전면일 때
...
//    /**
//     *  Saves a JEPG {@link Image} into the specified {@link File}
//     */
